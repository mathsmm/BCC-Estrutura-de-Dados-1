...
int main()
{
    ...
    // vector<int> v5 = Vetor::cria_embaralhado((int)round(pow(10, 1)));
    // vector<int> v6 = Vetor::cria_embaralhado((int)round(pow(10, 2)));
    // vector<int> v7 = Vetor::cria_embaralhado((int)round(pow(10, 3)));
    // vector<int> v8 = Vetor::cria_embaralhado((int)round(pow(10, 4)));
    // vector<int> v9 = Vetor::cria_embaralhado((int)round(pow(10, 5)));
    ...
    // int i = 6;
    // while (i <= 10)
    //     cout << to_string(Busca::busca_linear(vv[i], 3 * (int)round(pow(10, i++ - 6)))) << endl;
